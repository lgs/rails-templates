...
Use it at your own risk, this code is for my personal learning & testing purposes. 
   ...
   Actually tested with Ubuntu 9.04 Desktop Edition: to run on systems without sudo and other UNIX like, endemic command, please fork my GITHUB repo http://github.com/lgs/rails-templates/tree/master, git clone git@github.com:YOUR-OWN-GITHUB-REPO/rails-templates.git, find the lines "run" inside the template you'll use and sobstitute the command to run with a same function command for the OS you use. 
